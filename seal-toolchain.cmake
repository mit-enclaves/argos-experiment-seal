...
set(CMAKE_C_FLAGS "-Os -nostdinc -nodefaultlibs --sysroot=${CMAKE_SYSROOT} -isystem ${CMAKE_SYSROOT}/include/c++/v1 -isystem /usr/lib/llvm-14/lib/clang/14.0.0/include -isystem ${CMAKE_SYSROOT}/include -Wl,-z,norelro")
